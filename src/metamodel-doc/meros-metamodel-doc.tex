...
\label{ch:architecture}
	...
	\end{figure}
 	...
 	The Node (Fig.~\ref{fig:node_bdd}) aggregates ROS Parameters. ROS Component Container aggregates Nodes executed in a~single process. The Micro ROS Node, RQt Plugin Node and RViz are also considered in the model as the specialisations of the Node. Node lifecycle state\footnote{\url{https://design.ros2.org/articles/node_lifecycle.html}} is represented by the state machine states dedicated for this Node. These states have specific stereotypes.
