...
\label{ch:architecture}
	...
	In MeROS, ROS Communicating Component (Fig.~\ref{fig:communicating_components_bdd}) forms a~crucial generalisation to represent standardised role regarding communication. The ROS Command Line Tool is introduced as it also can communicate with other ROS Communicating Components after execution of particular ROS-related commands.
	
		
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.98]{diagrams/communicating_component_specialisations_bdd.png}}
		\end{center}
		\caption{Communicating Component and specialised blocks -- bdd.} 
		\label{fig:communicating_components_bdd}
	\end{figure}
	
	Relations of ROS Communicating Component are depicted in Fig.~\ref{fig:communicating_component_connections_bdd}. The diagram considers Topics, where the ROS Communicating Component can act as a~publisher or a~subscriber. In the case of Services, the ROS Communicating Component can act as a~server or a~client.	Similarly to Services, the ROS Communicating Component can act as a~server or a~client to an Action.	
	
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/communicating_component_connections_bdd.png}}
		\end{center}
	...
	\begin{figure}[hbt]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/action_bdd.png}}
		\end{center}
		\caption{Action.} 
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/communication_channel_bdd.png}}
		\end{center}
	...
	\end{figure}
 	...
 	The Node (Fig.~\ref{fig:node_bdd}) aggregates ROS Parameters. ROS Component Container aggregates Nodes executed in a~single process. The Micro ROS Node is also considered in the model as the specialisation of the Node. Node lifecycle state\footnote{\url{https://design.ros2.org/articles/node_lifecycle.html}} is represented by the state machine states dedicated for this Node. These states have specific stereotypes.
 	
	 
 	\begin{figure}[H]
	 	\centering
	 	\begin{center}
	 		{\includegraphics[scale=1.1]{diagrams/node_bdd.png}}
	 	\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.92]{diagrams/running_system_component_bdd.png}}
		\end{center}
	...
	\end{figure} 
	 ...
	 The specializations of ROS connection (Topic connections, Service connections, and Action connections) are depicted in Fig.~\ref{fig:ros_connections_bdd}. For particular connections types the appropriate communication structures are composed.
	
	
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.92]{diagrams/ros_connections_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.92]{diagrams/namespace_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/sources_executables_container_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/ros_package_bdd.png}}
		\end{center}
...
The composition of Repository is presented in Fig.~\ref{fig:repository_bdd}.	
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/repository_bdd.png}}
		\end{center}
		\caption{Repository composition.} 
		\label{fig:repository_bdd}
	\end{figure}

The composition of ROS Workspace is presented in Fig.~\ref{fig:ros_workspace_bdd}. The Workspace can extend other Workspaces by usage of \texttt{source} command.

	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/ros_workspace_bdd.png}}
		\end{center}
