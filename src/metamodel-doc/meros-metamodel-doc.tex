...
\label{ch:architecture}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/running_system_component_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/ros_connections_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.1]{diagrams/namespace_bdd.png}}
		\end{center}
