...
\label{ch:metamodel}
	...
	The stereotypes names are created to compromise the descriptiveness and short length. Hence, the ROS phrase is avoided in stereotypes unless only the ROS concept of a particular type exists.
...
\label{sec:metamodel-composition}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.85]{img/meros_pkg/ros_package_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.85]{img/meros_pkg/ros_workspace_bdd.png}}
		\end{center}
...
\label{ch:application-example}
	...
	\begin{figure}[H] 
		\centering
		\begin{center}
			{\includegraphics[scale=.95]{img/rico_pkg/general_sd.png}}
		\end{center}
