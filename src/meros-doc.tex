...
\label{ch:application-example}
	...
	\begin{figure}[H]
		...
		\end{center}
		\caption{Rico \stRunningSystem{} composition -- bdd.}
	...
	\begin{figure}[H]
		...
		\end{center}
		\caption{Structure of \stRunningSystem{}\texttt{:Rico} -- ibd.} 
	...
	\begin{figure}[H]
		...
		\end{center}
		\caption{Selected elements of \stIntrasystem{} \texttt{:Robot Core} -- ibd.} 
	...
	\begin{figure}[H]
		...
		\end{center}
		\caption{Example of \stCommChannel{} -- ibd.} 
	...
	\begin{figure}[H]
		...
		\end{center}
		\caption{Rico \stWorkspace{} composition -- Packages with Nodes -- bdd.}
	...
	\begin{figure}[H]
		...
		\end{center}
		\caption{Rico \stWorkspace{} composition -- Packages with Msgs -- bdd.}
