...
\label{sec:metamodel-composition}
	...
	\begin{figure}[H]
		...
		\end{center}
		\caption{Communicating Component and specialised blocks -- bdd. \twci{możę nazwa do skrócenia, żeby diagram nie był sztucznie poszerzony przez długą nazwę diagramu w etykiecie na górze}} 
