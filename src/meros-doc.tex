...
\label{ch:application-example}
	...
	The block definition diagram in Fig.~\ref{fig:rico_running_system_bdd} depicts the composition of \stRunSystem{} \texttt{:Rico}.
