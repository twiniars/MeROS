...
\begin{document}
	...
	\title{MeROS: SysML-based Metamodel for ROS-related Systems - version 1.2.9 - reference manual}
...
\label{sec:metamodel-composition}
	...
	The SysML blocks reflect ROS concepts [R3], and their composition is depicted in bdd (block definition diagrams). The metamodel is formulated in a~single SysML package. Hence, Sources Containers (especially Workspaces) and Intrasystems are composed into System (Fig.~\ref{fig:ros_system_bdd}). System can aggregate other Systems.
