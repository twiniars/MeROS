...
\begin{document}
	...
	\title{MeROS: SysML-based Metamodel for ROS-related Systems - version 1.2.3 - reference manual}
...
\label{sec:metamodel-composition}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.92]{img/meros_pkg/ros_package_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=.92]{img/meros_pkg/ros_workspace_bdd.png}}
		\end{center}
