...
\begin{document}
	...
	\title{MeROS: SysML-based Metamodel for ROS-related Systems - version 1.2.6 - reference manual}
...
\label{sec:metamodel-composition}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=1.0]{img/meros_pkg/communicating_components_specialisations_bdd.png}}
		\end{center}
