...
The resultant rosgraph diagram is presented in Fig.~\ref{fig:rqt_graph}.
...
\begin{figure}[H]
	...
	\label{fig:rqt_graph}
\end{figure}
There are two \stNode{}s visible as well as three \stTopic{}s between them. Two of them belong to an \stAction{}.
